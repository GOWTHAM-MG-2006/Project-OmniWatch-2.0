...
|4.7|**NexusUX v3.0**|Layer 11|Executive mode, Slack-native UX|React 19, TypeScript|
...
Mobile:        Removed (web-only dashboard)
...
|**Frontend**|React 19, TypeScript, FastAPI, Sigma.js, D3.js, TailwindCSS|
